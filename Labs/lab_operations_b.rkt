...
;; 2 PTS
(define (mean x1 x2 x3) (/(+ x1 x2 x3) 3)) 
  "TODO: Implement"
...
;; 3 PTS
(define (hypotenuse a b) (expt (+ (expt a 2)(expt b 2)) 1/2) )
  "TODO: Implement"
...
;; 3 PTS
(define (quadratic a b c x) (+ (* a (expt x 2)) (* b x) c))
  "TODO: Implement"
...
;; 2 PTS
(define (xor p q) (or (and (not p) q) (and p (not q))))
  "TODO: Implement"
...
;; 3 PTS
(define (isosceles p q r) (or (and p q (not r)) (and p r (not q)) (and r q (not p))))
  "TODO: Implement"
